        ...
        <Router>
            ...
            <nav className="App-header">
                ...
                <ul>
                    ...
                    priv:[userPrivilegs, setUserPrivilegs], uid:[userId, setUserId]}}>
            <Routes>
                    <Route path={props.state.home} element={<SharedLayout/>}>
                        ...
                        <Route path={props.state.form} element={<Form setChosenForum={props.setChosenForum} chosenForum={props.chosenForum}/>} />
