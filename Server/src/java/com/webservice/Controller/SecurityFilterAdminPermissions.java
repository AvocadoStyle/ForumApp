 ...
 */
@Provider
public class SecurityFilterAdminPermissions implements ContainerRequestFilter{

    private static final String AUTHORIZATION_HEADER_KEY = "Authorization";
    private static final String AUTHORIZATION_HEADER_PREFIX = "Basic ";
    private static final String SECURED_URL_PREFIX_DELETE = "delete_forum_name=";
    private static final String SECURED_URL_PREFIX_ADD = "add_forum_name=";
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        System.out.println(requestContext.getUriInfo().getQueryParameters().toString().contains(SECURED_URL_PREFIX_ADD));
        System.out.println(requestContext.getUriInfo().getQueryParameters().toString());
        if(requestContext.getUriInfo().getQueryParameters().toString().contains(SECURED_URL_PREFIX_DELETE) ||
                requestContext.getUriInfo().getQueryParameters().toString().contains(SECURED_URL_PREFIX_ADD)){
...
//                }
                try{
                    ...
                    if(ud.isUserAndPassExistsAdminPermissions(username, password)){
                        System.out.println("Authorized! wow!77777777777");
                        return;
                    }
                } catch(Exception e){
                    e.printStackTrace();
